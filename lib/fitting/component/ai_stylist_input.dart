...
List<RecommendationModel> _results = []; // 모델 이름 확인 (RecommendationModel)
...
Row(
children: [
Text('AI Stylist', style: _baseTextStyle.copyWith(fontSize: 16, fontWeight: FontWeight.w700)),
const SizedBox(width: 6),
Container(
padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 3),
decoration: BoxDecoration(color: PRIMARYCOLOR.withOpacity(0.1), borderRadius: BorderRadius.circular(6)),
child: const Text('PRO', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: PRIMARYCOLOR)),
)
],
),
const SizedBox(height: 2),
Text('당신만의 퍼스널 코디네이터', style: _baseTextStyle.copyWith(fontSize: 12, color: Colors.grey[500])),
],
),
],
);
...
style: _baseTextStyle.copyWith(color: Colors.grey[700], fontSize: 13, fontWeight: FontWeight.w500),
),
],
),
),
...
Text(
analysis,
style: _baseTextStyle.copyWith(fontSize: 16, fontWeight: FontWeight.w600, height: 1.6),
),
],
),
),
